...
\include{./chapter/ch01-icebreaker}
\include{./chapter/ch02-first-try}
\include{./chapter/ch03-basic-concepts}
\include{./chapter/ch04-prompt-elements}
\include{./chapter/ch05-general-tips}
\include{./chapter/ch06-prompting-basics}
\include{./chapter/ch07-prompting-intermediate}
\include{./chapter/ch08-prompting-advanced}
\include{./chapter/ch09-prompt-examples}
\include{./chapter/ch10-multimodal}
\include{./chapter/ch11-troubleshooting}
\include{./chapter/ch12-safety-ethics}
\include{./chapter/ch13-workflow}
